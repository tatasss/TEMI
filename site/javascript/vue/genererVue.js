...
genererVue = {
    ...
    resultatHtml: function (regime) {
        ...
        let cfe = this.recupDonneTab(modele().tauxeffMoyActualise.cfe, donne.pays.investissement.cfe, donne.pays.impots.cfe, false, false, false);
        let is = this.recupDonneTab(modele().tauxeffMoyActualise.isimf, donne.pays.investissement.isamort, donne.pays.impots.isImp, true, false, false);
        let imf = this.recupDonneTab(modele().tauxeffMoyActualise.isimf, donne.pays.investissement.imf, donne.pays.impots.imf, false, true, false);
        let irvm = this.recupDonneTab(modele().tauxeffMoyActualise.irvm, donne.pays.investissement.irvm, donne.pays.impots.irvm, false, false, false);
        let irc = this.recupDonneTab(modele().tauxeffMoyActualise.irc, donne.pays.investissement.irc, donne.pays.impots.irc, false, false, false);
        let tva = this.recupDonneTab(modele().tauxeffMoyActualise.tvaPetrole, donne.pays.investissement.tvaPetrole, donne.pays.impots.tva_petrole, false, false, false);
        let tot = this.recupDonneTab(modele().tauxeffMoyActualise.total, donne.pays.investissement.total, donne.pays.impots.imf, false, false, true);
    ...
    tabFluxTresorie: function (tab,color) {
    ...
    tauxRendementInt: function (tab) {
        return bootstrap.pan("default", null, bootstrap.tableSE(["courants"], null,{tab: myMath.arrondirTabUnit(tab, 2),color:""}));
    }
